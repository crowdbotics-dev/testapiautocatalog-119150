...
## Project Structure
    ...
    ├── testapiautocatalog_119150  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_119150`
...
2. Clone this repo and `cd testapiautocatalog_119150`
